		...
		<section class="yoast-seo-premium-extension">
			...
			<?php if ( $extension_list->is_installed( $extension->get_title() ) ) : ?>
				...
				<?php if ( $extensions->is_activated( 'wordpress-seo-premium' ) ) : ?>
					...
					<a target="_blank" href="<?php WPSEO_Shortlinker::show( 'https://yoa.st/pe-premium-page' ); ?>" class="yoast-link--license"><?php esc_html_e( 'Manage your subscription', 'wordpress-seo' ); ?></a>
				<?php else : ?>
